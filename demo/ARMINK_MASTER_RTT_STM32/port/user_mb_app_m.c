...
USHORT usReportSlaveID;
USHORT usReportRunIndicatorStatus;
UCHAR  ucReportAdditionalData[MB_FUNC_OTHER_REP_SLAVEID_BUF];
BOOL   xReportTruncated;
...
{
    usReportSlaveID            = ( USHORT ) usSlaveID;
    usReportRunIndicatorStatus = ( USHORT ) usRunIndicatorStatus;
    ...
    if( len > sizeof( ucReportAdditionalData ) )
    {
        ...
        xReportTruncated = TRUE;
    }
    else
    {
        xReportTruncated = FALSE;
    }
